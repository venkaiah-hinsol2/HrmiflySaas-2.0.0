<template>
    <div v-if="permsArray.includes('complaints_view') || permsArray.includes('admin')">
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('complaint.add')"
            :successMessage="$t('complaint.created')"
        />
    </div>
</template>
