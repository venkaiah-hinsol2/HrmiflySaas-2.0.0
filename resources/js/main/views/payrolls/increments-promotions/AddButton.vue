<template>
    ...
    >
        <template v-if="customType == 'menu'">
            <a-menu-item @click="showAdd" key="increments_promotions">
                <template #icon>
                    <slot name="icon"></slot>
                </template>
                <slot></slot>
        ...
        <template v-else>
            <a-tooltip
                v-if="tooltip"
                placement="topLeft"
                :title="$t('increment_promotion.add')"
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('increment_promotion.add')"
            :successMessage="$t('increment_promotion.created')"
        />
    </div>
</template>
<script>
