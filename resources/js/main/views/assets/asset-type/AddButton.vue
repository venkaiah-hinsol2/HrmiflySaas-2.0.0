<template>
    <div v-if="permsArray.includes('asset_types_view') || permsArray.includes('admin')">
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('asset_type.add')"
            :successMessage="$t('asset_type.created')"
        />
    </div>
</template>
