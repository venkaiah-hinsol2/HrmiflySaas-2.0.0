    ...
    >
        <a-row :gutter="16">
            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                ...
                >
                    <a-descriptions-item :label="$t('expense.user')">
                        {{ data.user ? data.user.name : "-" }}
                    </a-descriptions-item>
                    <a-descriptions-item :label="$t('expense.expense_category')">
                        {{ data.expense_category.name }}
                    </a-descriptions-item>
                    <a-descriptions-item :label="$t('expense.amount')">
                        {{ formatAmountCurrency(data.amount) }}
                    </a-descriptions-item>
                    <a-descriptions-item :label="$t('expense.reference_number')">
                    ...
                    <a-descriptions-item :label="$t('expense.bill')">
                        <div v-if="data.bill">
                            <a-typography-link :href="data.bill_url" target="_blank">
                                <a-tag color="success">
                                    <template #icon>
                                        <DownloadOutlined />
                                    </template>
