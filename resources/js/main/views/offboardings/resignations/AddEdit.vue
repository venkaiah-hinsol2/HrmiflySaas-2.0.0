    ...
    >
        <a-form layout="vertical">
            <a-tabs v-model:activeKey="activeKey">
                <a-tab-pane
                    key="resignation_details"
                    :tab="`${$t('resignation.resignation_details')}`"
                >
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            <a-form-item
                                :label="$t('resignation.user')"
                                name="user_id"
                    ...
                    <a-row :gutter="16" v-if="formData.status == 'approved'">
                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                ...
                                name="end_date"
                                :help="(rules.end_date ? rules.end_date.message : null||rules.last_date ? rules.last_date.message : null)"
                                :validateStatus="rules.end_date||rules.last_date ? 'error' : null"
                                class="required"
                            >
                                <DateTimePicker
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const users = ref([]);
        const userUrl = "users";
        const activeKey = ref("resignation_details");
        ...
        watch(
            ...
            async (newVal, oldVal) => {
                ...
                if (props.visible) {
                    activeKey.value = "resignation_details";
