<template>
    <AdminPageHeader>
        <template #header>
            <a-page-header :title="$t(`menu.indicators`)" class="p-0" />
        </template>
        <template #breadcrumb>
        ...
        <a-row :gutter="[16, 16]">
            <a-col :xs="24" :sm="24" :md="12" :lg="10" :xl="10">
                <a-space>
                    <template
                        v-if="
                            permsArray.includes('indicators_create') ||
                    ...
                    <a-button
                        v-if="
                            ...
                            (permsArray.includes('indicators_delete') ||
                                permsArray.includes('admin'))
                        "
                        type="primary"
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            crudVariables.langKey.value = "indicator";
