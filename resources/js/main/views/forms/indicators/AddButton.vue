<template>
    <div v-if="permsArray.includes('indicators_create') || permsArray.includes('admin')">
        <a-tooltip
            v-if="tooltip"
            placement="topLeft"
            :title="$t('indicator.add')"
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('indicator.add')"
            :successMessage="$t('indicator.created')"
        />
    </div>
</template>
<script>
