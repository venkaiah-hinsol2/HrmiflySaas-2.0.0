<template>
    <AdminPageHeader>
        <template #header>
            <a-page-header :title="$t(`menu.salary_groups`)" class="p-0" />
        </template>
        <template #breadcrumb>
...
export default {
    ...
    setup() {
        ...
        const salaryComponentUrl = "salary-components?fields=id,xid,name";
        ...
        onMounted(() => {
            ...
            crudVariables.langKey.value = "salary_group";
