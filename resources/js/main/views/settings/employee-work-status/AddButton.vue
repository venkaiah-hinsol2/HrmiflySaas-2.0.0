<template>
    ...
    >
        <template v-if="customType == 'menu'">
            <a-menu-item @click="showAdd" key="employee_work_status">
                <template #icon>
                    <slot name="icon"></slot>
                </template>
                <slot></slot>
        ...
        <template v-else>
            <a-tooltip
                v-if="tooltip"
                placement="topLeft"
                :title="$t('employee_work_status.add')"
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('employee_work_status.add')"
            :successMessage="$t('employee_work_status.created')"
        />
    </div>
</template>
