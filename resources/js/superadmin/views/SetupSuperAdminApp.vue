<template>
    <a-layout class="layout">
        ...
        <a-layout-content style="padding: 0 50px">
                ...
                <a-row>
                    <a-col :span="21" :offset="1">
                        <a-alert
                            ...
                            :description="
                                $t(
                                    'setup_superadmin_company.setup_not_completed_description'
                                )
                            "
                            type="error"
                            show-icon
                        ...
                        <a-steps :current="currentStep">
                            ...
                            <a-step :status="companyWhiteLabelStepStatus">
                                <template #title>
                                    {{
                                        $t(
                                            "setup_superadmin_company.white_label_settings"
                                        )
                                    }}
                                </template>
                                <template #description>
                                    <span>{{
                                        $t(
                                            "setup_superadmin_company.white_label_descrtipion"
                                        )
                                    }}</span>
                                </template>
                            </a-step>
                            <a-step :status="companySettingStepStatus">
                                ...
                                <template #description>
                                    <span>{{
                                        $t(
                                            "setup_superadmin_company.set_company_basic_settings"
                                        )
                                    }}</span>
                                </template>
                            </a-step>
                        ...
                        >
                            <a-space>
                                ...
                                <a-button
                                    ...
                                    @click="goNext"
                                    :disabled="
                                        currentStep >= correctStep && currentStep != 1
                                    "
                                >
            ...
            <a-modal
                v-model:open="showConfirmWhiteLabelModal"
                :maskClosable="false"
                :footer="null"
                centered
            >
                <a-result>
                    <template #title>
                        <span :style="{ color: '#7676e3' }">
                            {{
                                $t(
                                    "setup_superadmin_company.white_label_settings_completed"
                                )
                            }}
                        </span>
                    </template>
